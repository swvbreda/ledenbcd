...
member_locations AS (
  -- Ontdubbel identieke vestigingen (zelfde adres + postcode) binnen hetzelfde lid.
...
unique_unmatched AS (
  -- Eén regel per adres over alle leden heen, en nooit een adres dat al via het register meetelt.
