...
interface Props {
  ...
  onAddExpense: (expense: { line_item_id: string; description?: string; amount: number; expense_date?: string; creditor_name?: string; created_by: string }) => void;
        ...
        <div className="space-y-4">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-border">
                  ...
                  <th className="text-left px-2 py-1 text-muted-foreground font-medium">Crediteur</th>
              ...
              <tbody>
                {expenses.map((e) => (
                  <tr key={e.id} className="border-b border-border/50">
                    ...
                    <td className="px-2 py-1">{e.expense_date || "-"}</td>
                ...
                <tr className="font-medium bg-muted/30">
                  <td className="px-2 py-1" colSpan={3}>Totaal</td>
          ...
          <div className="border-t border-border pt-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <Input placeholder="Crediteur" value={creditor} onChange={(e) => setCreditor(e.target.value)} className="h-8 text-sm" />
